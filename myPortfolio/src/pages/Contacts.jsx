                ...
                <ul className="flex justify-center items-center w-2/4 h-10 bg-zinc-800 border-zinc-700 border-1 rounded-tr-2xl rounded-bl-2xl shadow-5">
                    <Link className="w-1/3 h-full" to="/">
                        <span className="flex h-full items-center justify-center rounded-bl-2xl hover:shadow-inner hover:shadow-zinc-900 hover:duration-150 group">
                                <p className="text-xl text-purple-500 group-hover:text-zinc-300">Sobre</p>
                        </span>
                    </Link>
                    ...
                    <Link className="w-1/3 h-full" to="/contacts">
                        <span className="flex h-full items-center justify-center rounded-tr-2xl shadow-inner shadow-zinc-900 hover:shadow-inner hover:shadow-zinc-900 group">
